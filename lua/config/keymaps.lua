...
map("n", "<Leader>tf", "<CMD>lua _TERMINAL_TOGGLE()<CR>", { desc = "Float" })
map("n", "<Leader>th", "<CMD>lua _TERMINAL_HORIZONTAL_TOGGLE()<CR>", { desc = "Horizontal" })
map("n", "<Leader>tm", "<CMD>lua _MC_TOGGLE()<CR>", { desc = "Midnight Commander" })
map("n", "<Leader>tp", "<CMD>lua _PYTHON_TOGGLE()<CR>", { desc = "Python" })
map("n", "<Leader>tv", "<CMD>lua _TERMINAL_VERTICAL_TOGGLE()<CR>", { desc = "Vertical" })
...
map("n", "[c", "<CMD>lua require('gitsigns').prev_hunk()<CR>", { desc = "Previous change" })
map("n", "]c", "<CMD>lua require('gitsigns').next_hunk()<CR>", { desc = "Next change" })
...
-- Substitute plugin
map("n", "cx", "<CMD>lua require('substitute.exchange').operator()<CR>", { desc = "Exchange" })
map("n", "cxx", "<CMD>lua require('substitute.exchange').line()<CR>", { desc = "Exchange line" })
map("n", "cxc", "<CMD>lua require('substitute.exchange').cancel()<CR>", { desc = "Cancel exchange" })
map("x", "X", "<CMD>lua require('substitute.exchange').visual()<CR>", { desc = "Cancel exchange" })

-- Leap plugin
map("n", "<Tab>", "<Plug>(leap-forward-to)", { desc = "2 character search" })
map("n", "<S-Tab>", "<Plug>(leap-backward-to)", { desc = "2 character search" })
map("n", "M", "<CMD>lua require('leap-ast').leap()<CR>", { desc = "Leap to parent AST node" })
map("v", "<Tab>", "<Plug>(leap-forward-to)", { desc = "2 character search" })
map("v", "<S-Tab>", "<Plug>(leap-backward-to)", { desc = "2 character search" })
map("v", "M", "<CMD>lua require('leap-ast').leap()<CR>", { desc = "Select AST node" })
map("o", "<Tab>", "<Plug>(leap-forward-to)", { desc = "2 character search" })
map("o", "<S-Tab>", "<Plug>(leap-backward-to)", { desc = "2 character search" })
map("o", "M", "<CMD>lua require('leap-ast').leap()<CR>", { desc = "Parent AST node" })
