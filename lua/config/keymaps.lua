...
-- Normal mode
map("n", "<Leader>-", "<CMD>split<CR>", { desc = "Open current file in new split" })
map("n", "<Leader><Leader>-", "<CMD>new<CR>", { desc = "Open new file in new split" })
map("n", "<Leader>\\", "<CMD>vsplit<CR>", { desc = "Open current file in new vsplit" })
map("n", "<Leader><Leader>\\", "<CMD>vnew<CR>", { desc = "Open new file in new vsplit" })
