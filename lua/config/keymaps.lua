...
map("v", "al", ":<C-u>normal! 0v$<CR>", { desc = "Select a line" })
map("v", "il", ":<C-u>normal! ^vg_<CR>", { desc = "Select inner line" })
...
map("o", "i/", "<CMD>normal! T/vt/<CR>", { desc = "inner /" })
map("o", "a/", "<CMD>normal! F/vt/<CR>", { desc = "a /" })
map("o", "i,", "<CMD>normal! T,vt,<CR>", { desc = "inner ," })
map("o", "a,", "<CMD>normal! F,vt,<CR>", { desc = "a ," })
map("o", "i.", "<CMD>normal! T.vt.<CR>", { desc = "inner ." })
map("o", "a.", "<CMD>normal! F.vt.<CR>", { desc = "a ." })
map("o", "i_", "<CMD>normal! T_vt_<CR>", { desc = "inner _" })
map("o", "a_", "<CMD>normal! F_vt_<CR>", { desc = "a _" })
map("o", "i-", "<CMD>normal! T-vt-<CR>", { desc = "inner -" })
map("o", "a-", "<CMD>normal! F-vt-<CR>", { desc = "a -" })
map("o", "i%", "<CMD>normal! T%vt%<CR>", { desc = "inner %" })
map("o", "a%", "<CMD>normal! F%vt%<CR>", { desc = "a %" })
