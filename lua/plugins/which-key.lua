  ...
  opts = {
    ...
    icons = {
      ...
      rules = {
        ...
        { pattern = "%[diffview%]", icon = "󰊢 diffview", color = "orange" },
        { pattern = "%[fidget%]", icon = "󰍡 fidget", color = "purple" },
        ...
        { pattern = "%[helpview%]", icon = "󰋖 helpview", color = "purple" },
        ...
        { pattern = "%[octo%]", icon = "󰊢 octo", color = "orange" },
