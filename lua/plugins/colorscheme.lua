  ...
  config = function()
    ...
    require("gruvbox").setup({
      ...
      overrides = {
        ...
        GruvboxAquaUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        ...
        GruvboxBlueUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        ...
        GruvboxGreenUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        GruvboxOrange = { bg = "", blend = 0 },
        GruvboxOrangeBold = { bg = "", blend = 0 },
        GruvboxOrangeSign = { bg = "", blend = 0 },
        GruvboxOrangeUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        GruvboxPurple = { bg = "", blend = 0 },
        GruvboxPurpleBold = { bg = "", blend = 0 },
        GruvboxPurpleSign = { bg = "", blend = 0 },
        GruvboxPurpleUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        GruvboxRed = { bg = "", blend = 0 },
        GruvboxRedBold = { bg = "", blend = 0 },
        GruvboxRedSign = { bg = "", blend = 0 },
        GruvboxRedUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
        GruvboxYellow = { bg = "", blend = 0 },
        GruvboxYellowBold = { bg = "", blend = 0 },
        GruvboxYellowSign = { bg = "", blend = 0 },
        GruvboxYellowUnderline = { bg = "", blend = 0, underline = false, underdotted = true },
      },
    })
