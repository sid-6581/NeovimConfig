...
M.spec = {
  ...
  keys = {
    ...
    { "<F1>", function() require("snacks").picker.help() end, mode = { "n", "i", "v", "x", "o", "c", "t" }, desc = "Search help [snacks]" },
    { "<F3>", function() require("snacks").picker.keymaps() end, mode = { "n", "i", "v", "x", "o", "c", "t" }, desc = "Search keymaps [snacks]" },
