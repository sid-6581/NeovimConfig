...
local mappings = {
  ...
  { "\\\\A",            name = "Visual All",           desc = "Select all occurrences of visual selection",  perm = true, mode = "v", },
  { "\\\\/",            name = "Visual Regex",         desc = "Find a pattern in visual selection",          perm = true, mode = "v", },
  { "\\\\f",            name = "Visual Find",          desc = "Find all patterns (or @/) from visual mode",  perm = true, mode = "v", },
  { "\\\\c",            name = "Visual Cursors",       desc = "Create a column of cursors from visual mode", perm = true, mode = "v", },
  { "\\\\a",            name = "Visual Add",           desc = "Create a region from visual mode",            perm = true, mode = "v", },
  { "\\\\s",            name = "Visual Subtract",      desc = "Remove regions in current visual selection",  perm = true, mode = "v", },
  { "\\\\r",            name = "Visual Reduce",        desc = "Remove regions outside of visual selection",  perm = true, mode = "v", },
